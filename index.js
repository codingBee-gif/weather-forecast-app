function dateFormat(timestamp) {
        ...
        async function fetchAQIData(lat, lon) {
            ...
            document.getElementById("so2Value").innerText = list.so2
        ...
        async function fetchData() {
            ...
            document.getElementById("skyDesc").innerText = skyDescription
            document.getElementById("humidity").innerText=formattedData.main.humidity
            document.getElementById("pressure").innerText=formattedData.main.pressure
            document.getElementById("feelsLike").innerText=formattedData.main.feels_like
            document.getElementById("visiblity").innerText=formattedData.visibility
            ...
            document.getElementById("sunriseTime").innerText = properSunriseTime
            document.getElementById("sunsetTime").innerText = properSunsetTime
